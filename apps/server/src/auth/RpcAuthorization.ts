...
export const RPC_REQUIRED_SCOPES = {
  ...
  [AUTOMATION_WS_METHODS.getSnapshot]: AuthOrchestrationReadScope,
  [AUTOMATION_WS_METHODS.subscribe]: AuthOrchestrationReadScope,
  [AUTOMATION_WS_METHODS.getDetail]: AuthOrchestrationReadScope,
  [AUTOMATION_WS_METHODS.getRunsPage]: AuthOrchestrationReadScope,
  [AUTOMATION_WS_METHODS.previewSchedule]: AuthOrchestrationReadScope,
  [AUTOMATION_WS_METHODS.create]: AuthOrchestrationOperateScope,
  [AUTOMATION_WS_METHODS.update]: AuthOrchestrationOperateScope,
  [AUTOMATION_WS_METHODS.pause]: AuthOrchestrationOperateScope,
  [AUTOMATION_WS_METHODS.resume]: AuthOrchestrationOperateScope,
  [AUTOMATION_WS_METHODS.delete]: AuthOrchestrationOperateScope,
  [AUTOMATION_WS_METHODS.runNow]: AuthOrchestrationOperateScope,
  // Webhook reads reveal the secret delivery URL, so they require the same
  // scope that can create agent turns.
  [WEBHOOK_WS_METHODS.getSnapshot]: AuthOrchestrationOperateScope,
  [WEBHOOK_WS_METHODS.subscribe]: AuthOrchestrationOperateScope,
  [WEBHOOK_WS_METHODS.getDetail]: AuthOrchestrationOperateScope,
  [WEBHOOK_WS_METHODS.getDeliveriesPage]: AuthOrchestrationOperateScope,
  [WEBHOOK_WS_METHODS.create]: AuthOrchestrationOperateScope,
  [WEBHOOK_WS_METHODS.update]: AuthOrchestrationOperateScope,
  [WEBHOOK_WS_METHODS.pause]: AuthOrchestrationOperateScope,
  [WEBHOOK_WS_METHODS.resume]: AuthOrchestrationOperateScope,
  [WEBHOOK_WS_METHODS.rotateSecret]: AuthOrchestrationOperateScope,
  [WEBHOOK_WS_METHODS.delete]: AuthOrchestrationOperateScope,
