...
const makeWsRpcLayer = (
  ...
  WsRpcGroup.toLayer(
    Effect.gen(function* () {
      ...
      const bootstrapTurnLauncher = yield* BootstrapTurnLauncher.BootstrapTurnLauncher;
      const automationService = yield* AutomationService.AutomationService;
      const automationRunner = yield* AutomationRunner.AutomationRunner;
      const automationScheduler = yield* AutomationScheduler.AutomationScheduler;
      const webhookService = yield* WebhookService.WebhookService;
      ...
      const dispatchNormalizedCommand = (
        ...
        const dispatchEffect =
          normalizedCommand.type === "thread.turn.start" && normalizedCommand.bootstrap
            ? bootstrapTurnLauncher.dispatch(normalizedCommand)
            : orchestrationEngine
      ...
      return WsRpcGroup.of({
        ...
        [AUTOMATION_WS_METHODS.getSnapshot]: (_input) =>
          observeRpcEffect(AUTOMATION_WS_METHODS.getSnapshot, automationService.getSnapshot(), {
            "rpc.aggregate": "automation",
          }),
        [AUTOMATION_WS_METHODS.subscribe]: (_input) =>
          observeRpcStreamEffect(AUTOMATION_WS_METHODS.subscribe, automationService.subscribe(), {
            "rpc.aggregate": "automation",
          }),
        [AUTOMATION_WS_METHODS.getDetail]: (input) =>
          observeRpcEffect(AUTOMATION_WS_METHODS.getDetail, automationService.getDetail(input), {
            "rpc.aggregate": "automation",
          }),
        [AUTOMATION_WS_METHODS.getRunsPage]: (input) =>
          observeRpcEffect(
            AUTOMATION_WS_METHODS.getRunsPage,
            automationService.getRunsPage(input),
            { "rpc.aggregate": "automation" },
          ),
        [AUTOMATION_WS_METHODS.previewSchedule]: (input) =>
          observeRpcEffect(
            AUTOMATION_WS_METHODS.previewSchedule,
            automationService.previewSchedule(input),
            { "rpc.aggregate": "automation" },
          ),
        [AUTOMATION_WS_METHODS.create]: (input) =>
          observeRpcEffect(
            AUTOMATION_WS_METHODS.create,
            automationService.create(input).pipe(Effect.tap(() => automationScheduler.wake)),
            { "rpc.aggregate": "automation" },
          ),
        [AUTOMATION_WS_METHODS.update]: (input) =>
          observeRpcEffect(
            AUTOMATION_WS_METHODS.update,
            automationService.update(input).pipe(Effect.tap(() => automationScheduler.wake)),
            { "rpc.aggregate": "automation" },
          ),
        [AUTOMATION_WS_METHODS.pause]: (input) =>
          observeRpcEffect(
            AUTOMATION_WS_METHODS.pause,
            automationService.pause(input).pipe(Effect.tap(() => automationScheduler.wake)),
            { "rpc.aggregate": "automation" },
          ),
        [AUTOMATION_WS_METHODS.resume]: (input) =>
          observeRpcEffect(
            AUTOMATION_WS_METHODS.resume,
            automationService.resume(input).pipe(Effect.tap(() => automationScheduler.wake)),
            { "rpc.aggregate": "automation" },
          ),
        [AUTOMATION_WS_METHODS.delete]: (input) =>
          observeRpcEffect(
            AUTOMATION_WS_METHODS.delete,
            automationService.delete(input).pipe(Effect.tap(() => automationScheduler.wake)),
            { "rpc.aggregate": "automation" },
          ),
        [AUTOMATION_WS_METHODS.runNow]: (input) =>
          observeRpcEffect(AUTOMATION_WS_METHODS.runNow, automationRunner.runNow(input), {
            "rpc.aggregate": "automation",
          }),
        [WEBHOOK_WS_METHODS.getSnapshot]: (_input) =>
          observeRpcEffect(WEBHOOK_WS_METHODS.getSnapshot, webhookService.getSnapshot(), {
            "rpc.aggregate": "webhook",
          }),
        [WEBHOOK_WS_METHODS.subscribe]: (_input) =>
          observeRpcStreamEffect(WEBHOOK_WS_METHODS.subscribe, webhookService.subscribe(), {
            "rpc.aggregate": "webhook",
          }),
        [WEBHOOK_WS_METHODS.getDetail]: (input) =>
          observeRpcEffect(WEBHOOK_WS_METHODS.getDetail, webhookService.getDetail(input), {
            "rpc.aggregate": "webhook",
          }),
        [WEBHOOK_WS_METHODS.getDeliveriesPage]: (input) =>
          observeRpcEffect(
            WEBHOOK_WS_METHODS.getDeliveriesPage,
            webhookService.getDeliveriesPage(input),
            { "rpc.aggregate": "webhook" },
          ),
        [WEBHOOK_WS_METHODS.create]: (input) =>
          observeRpcEffect(WEBHOOK_WS_METHODS.create, webhookService.create(input), {
            "rpc.aggregate": "webhook",
          }),
        [WEBHOOK_WS_METHODS.update]: (input) =>
          observeRpcEffect(WEBHOOK_WS_METHODS.update, webhookService.update(input), {
            "rpc.aggregate": "webhook",
          }),
        [WEBHOOK_WS_METHODS.pause]: (input) =>
          observeRpcEffect(WEBHOOK_WS_METHODS.pause, webhookService.pause(input), {
            "rpc.aggregate": "webhook",
          }),
        [WEBHOOK_WS_METHODS.resume]: (input) =>
          observeRpcEffect(WEBHOOK_WS_METHODS.resume, webhookService.resume(input), {
            "rpc.aggregate": "webhook",
          }),
        [WEBHOOK_WS_METHODS.rotateSecret]: (input) =>
          observeRpcEffect(WEBHOOK_WS_METHODS.rotateSecret, webhookService.rotateSecret(input), {
            "rpc.aggregate": "webhook",
          }),
        [WEBHOOK_WS_METHODS.delete]: (input) =>
          observeRpcEffect(WEBHOOK_WS_METHODS.delete, webhookService.delete(input), {
            "rpc.aggregate": "webhook",
          }),
